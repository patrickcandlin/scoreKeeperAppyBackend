...
class PlayerMatchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create player_match" do
    assert_difference('PlayerMatch.count') do
      post player_matches_url, params: { player_match: { match_id: @player_match.match_id, player_id: @player_match.player_id } }, as: :json
    end
  ...
  test "should update player_match" do
    patch player_match_url(@player_match), params: { player_match: { match_id: @player_match.match_id, player_id: @player_match.player_id } }, as: :json
    assert_response 200
  end
